...
export default function Iridescence({ color = [1.0, 0.27, 0.0], speed = 1.0, amplitude = 0.1, mouseReact = true, ...rest }) {
  ...
  useEffect(() => {
    ...
    let renderer, gl, animateId, program;
    try {
      renderer = new Renderer();
      gl = renderer.gl;
      if (!gl) {
        console.warn('Iridescence: WebGL not available, skipping background');
        return;
      }
      ...
      console.warn('Iridescence: Failed to initialize WebGL background', error);
